package api.input_entities_api.movie;

import api.input.classes.input_manager.InputManager;
import api.input_entities_api.exceptions.IncorrectInputException;
import api.input_entities_api.movie.coordinates.CoordinatesBuilderDirector;
import api.input_entities_api.movie.genre.GenreBuilderDirector;
import api.input_entities_api.movie.mpaa_rating.MpaaRatingBuilderDirector;
import api.input_entities_api.movie.name.NameBuilderDirector;
import api.input_entities_api.movie.operator.OperatorBuilderDirector;
import api.input_entities_api.movie.oscars_count.OscarsCountBuilderDirector;
import api.input_entities_api.types_builder.MovieBuilder;
