...
import repository.csv.adapters.CsvReader;
import repository.csv.adapters.CsvWriter;
import repository.exceptions.KeyNotFoundException;
import repository.interfaces.ArrayManipulator;
...
public class CsvRepository implements Repository, ArrayManipulator {
     ...
     */
    @Override
    public Movie get(int id) throws KeyNotFoundException {
     ...
     */
    @Override
    public void put(int id, Movie movie) throws KeyNotFoundException {
        int index = -1;
